...
- Escribas tests para endpoints API de Flask
- Pruebes modelos de base de datos y relaciones
- Valides lógica de negocio
- Mockees operaciones de base de datos
- Realices pruebas de integración
...
```
Tests Unitarios         → Funciones individuales, modelos
Tests de Integración    → Endpoints API + base de datos
